...
#ifndef BEHAVIOR_TREES_NAVEGAR3TR_H
#define BEHAVIOR_TREES_NAVEGAR3TR_H
...
class Navegar3TR : public BT::ActionNodeBase
{
  public:

    explicit Navegar3TR(const std::string& name , const BT::NodeConfiguration& config);
    ...
    void ageCallback(const std_msgs::Bool::ConstPtr& age);
